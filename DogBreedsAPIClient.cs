...
namespace APIVerve
{
    ...
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dogbreeds";
        ...
        public DogBreedsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public DogBreedsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DogBreedsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(DogBreedsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(DogBreedsQueryOptions options)
        {
